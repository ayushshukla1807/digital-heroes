...
> **https://digital-heroes-topaz.vercel.app**
...
### 1. User Flow
1. Visit [/signup](https://digital-heroes-topaz.vercel.app/signup)
2. Create account → select a charity → confirm
3. You land on [/dashboard](https://digital-heroes-topaz.vercel.app/dashboard)
...
7. Go to [/dashboard/checkout](https://digital-heroes-topaz.vercel.app/dashboard/checkout) → choose Monthly/Yearly → PayPal

### 2. Admin Flow
1. Visit [/admin](https://digital-heroes-topaz.vercel.app/admin)
...
1. Visit [/auditor](https://digital-heroes-topaz.vercel.app/auditor) — read-only revenue overview with Recharts chart
2. [/auditor/draws](https://digital-heroes-topaz.vercel.app/auditor/draws) — expand any draw to see winner breakdown
3. [/auditor/charities](https://digital-heroes-topaz.vercel.app/auditor/charities) — see fund flow per charity with transfer status
...
| Evaluator UX | Basic login | **Floating Instant Evaluator Access Panel** (1-click credentials) |
| Branding | Generic UI | **100% Digital Heroes brand match** (Cyan `#06b6d4`, Space Grotesk) |
| Personal Touch | None | **Lucknow, UP company tribute** |
